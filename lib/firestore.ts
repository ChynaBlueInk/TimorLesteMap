...
export const SEED_PLACES: Place[] = [
  {
    ...
    municipality: "Díli",
    suco: "Metiaut",
    coords: { lat: -8.5188, lng: 125.6050 },
  ...
  },
  {
    ...
    suco: "Maubara",
    coords: { lat: -8.7523, lng: 125.3970 },
...
export const getPlaces = async (): Promise<Place[]>=>{
  return readJSON<Place[]>(PLACES_KEY, SEED_PLACES)
}
...
export const getPlaceStats = async (): Promise<{
  total: number, published: number, pending: number, flagged: number, featured: number
}>=>{
